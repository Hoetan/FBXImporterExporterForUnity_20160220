...
public class NeuronAnimatorInstance : NeuronInstance
{
	...
	{		
		...
		SetRotation( animator, HumanBodyBones.RightThumbProximal,		actor.GetReceivedRotation( NeuronBones.RightHandThumb1) + new Vector3(0.0f, 50.0f, 0.0f) );
		...
		SetRotation( animator, HumanBodyBones.LeftThumbProximal,		actor.GetReceivedRotation( NeuronBones.LeftHandThumb1 ) + new Vector3(0.0f, -50.0f, 0.0f) );
