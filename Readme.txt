...
FBX Importer & Exporter for Unity β Trial Version 2016/02/20
...
■対応3Dエンジン
 ...
 Unity Personal/Professional v5.3.2f1 (64bit)
...
■対応Visual C++ランタイム
 ...
 Visual Studio 2015 Update 1 の Visual C++ 再頒布可能パッケージ: https://www.microsoft.com/ja-jp/download/details.aspx?id=49984
...
■使用ライブラリ(DLL)
 ...
 FBX SDK 2016.1.2 VS2015 (64bit): http://www.autodesk.com/products/fbx/overview

※「DllNotFoundException: Assets/FBXImporter&ExporterForUnity/FBXImporterForUnity/Plugins/x86_64/FBXImporterForUnity.dll」
※「DllNotFoundException: Assets/FBXImporter&ExporterForUnity/FBXExporterForUnity/Plugins/x86_64/FBXExporterForUnity.dll」

　のエラーがでた場合は、上記のＳＤＫにあるＤＬＬのコピーが必須です。
　「C:\Program Files\Autodesk\FBX\FBX SDK\2016.1.2\lib\vs2015\x64\release\libfbxsdk.dll」を、Unityプロジェクトのルート（※）へコピーしてください。
...
Japanese: https://www.microsoft.com/ja-jp/download/details.aspx?id=49984
English: https://www.microsoft.com/en-us/download/details.aspx?id=49984
...
Copy the DLL found from this path, "C:\Program Files\Autodesk\FBX\FBX SDK\2016.1.2\lib\vs2015\x64\release\libfbxsdk.dll", to the root (*) of the Unity project.
